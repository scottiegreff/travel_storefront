      ...
      <div>
        ...
        <div className="md:grid md:grid-cols-2 gap-8 text-[#C68DBA]">
          ...
          <div className="flex flex-col gap-2 my-3 md:my-0">
            ...
            >
              ...
              <SelectContent className="w-[20vw] mt-1 block pr-10 py-2 text-base border-gray-300 sm:text-sm rounded-md">
        ...
        <div className="flex justify-center items-center">
          <Button
            onClick={onSubmit}
            disabled={loading}
            className="py-6 mt-10 w-full md:w-[25vw] md:text-lg border bg-[#C68DBA] shadow-lg"
          >
            {action}
          </Button>
        </div>
